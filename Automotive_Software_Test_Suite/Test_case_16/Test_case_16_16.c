...
static void Test_case_16_44(float input1, int32_T int_var )
 {
...
int main_Test_case_16_44(float input1)
{

    rReal_T float_arr[150];
    int32_T int_var;
    int32_T i;
		void(*funcPtr) (float,int32_T ) = Test_case_16_44;
