...
boolean Test_case_36_15(uint32 * param_uint_ptr, const struc * const param_struc_ptr)
{
	uint32 i;
...
int main_Test_case_36_15(void)
{
	...
	static const struc struc_var={
		...
		case 6:
			...
			bool_var = Test_case_36_15(&(input1[0]), &struc_var);
			break;
		default:
			assert(0);
			break;
