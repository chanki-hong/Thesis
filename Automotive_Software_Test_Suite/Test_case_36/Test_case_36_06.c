...
boolean Test_case_36_10(uint32 * param_uint_ptr, const struc * const param_struc_ptr)
{
	uint32 i;
...
int globalTrue = 1; /* false */

int main_Test_case_36_10(void)
{
	...
	if (globalTrue){
		...
		bool_var = Test_case_36_10(&(input1[0]), &struc_var);
	}
	else{
		assert(0);
	}
