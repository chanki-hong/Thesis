...
boolean Test_case_36_18(uint32 * param_uint_ptr, const struc * const param_struc_ptr)
{
	uint32 i;
...
source:
	...
	bool_var = Test_case_36_18(&(input1[0]), &struc_var);
