...
boolean Test_case_36_04(uint32 * param_uint_ptr, const struc * const param_struc_ptr)
{
	uint32 i;
...
int main_Test_case_36_04(void)
{
	...
	if (STATIC_CONST_TRUE){
		...
		bool_var = Test_case_36_04(&(input1[0]), &struc_var);
	}
	else{
		assert(0);
	}
