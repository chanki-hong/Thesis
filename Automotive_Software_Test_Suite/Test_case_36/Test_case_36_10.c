...
boolean Test_case_36_17(uint32 * param_uint_ptr, const struc * const param_struc_ptr)
{
	uint32 i;
...
int main_Test_case_36_17(void)
{
	...
	for(int i=0; i<1; i++){
		...
		bool_var = Test_case_36_17(&(input1[0]), &struc_var);
	}
