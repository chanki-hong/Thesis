...
boolean Test_case_36_09(uint32 * param_uint_ptr, const struc * const param_struc_ptr)
{
	uint32 i;
...
const int GLOBAL_CONST_TRUE = 1; /* false */

int main_Test_case_36_09(void)
{
	...
	if (GLOBAL_CONST_TRUE){
		...
		bool_var = Test_case_36_09(&(input1[0]), &struc_var);
	}
	else{
		assert(0);
	}
