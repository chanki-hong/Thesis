...
boolean Test_case_36_01(uint32 * param_uint_ptr, const struc * const param_struc_ptr)
{
	uint32 i;
...
int main_Test_case_36_01(void)
{
	...
	bool_var = Test_case_36_01(&(input1[0]), &struc_var);
