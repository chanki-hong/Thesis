...
typedef int sint32;
 ...
 static void TAHMI_Sink_44(unsigned int input1,float input2  )
 {
	  int32_T i;
...
int main_Test_case_18_44(unsigned int input1, float input2)
{
    int32_T int_var;
    rReal_T float_var;
	...
	void(*funcPtr) (unsigned int,float) = TAHMI_Sink_44;


	
	funcPtr( input1, input2  );
