...
void Test_case_19_subfunc_15(uint32_T *Param_uint_ptr1, uint32_T *Param_uint_ptr2, rReal_T u, const
...
void Test_case_19_func_15(rReal_T *Param_float_ptr1, const rReal_T *Param_float_ptr2, rReal_T u, const
	rReal_T *Param_float_ptr3, uint32_T iHi)
{
	uint32_T uint_var;
	uint32_T uint_var2;
	Test_case_19_subfunc_15(&(uint_var), &(uint_var2), u, Param_float_ptr3, iHi);
...
int main_Test_case_19_15(float input1,float input1_1,float input2)
{
	rReal_T float_var1;
	rReal_T float_var2;
	...
	if ((input1 >= 0.0f) && (input1 <= 66.0f)) {
		if ((input1_1 >= 0.00006f) && (input1_1 <= 66.0f)) {
			if ((input2 >= 0.0f) && (input1_1 <= 1.0f)) {
				...
				Test_case_19_func_15(&(float_var1),
					&float_arr2[0],
					0.0001f,
					&float_arr1[0], 1U);
