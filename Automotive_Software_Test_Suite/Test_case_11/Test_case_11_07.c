...
static void Test_case_11_07_Func2(uint8* param_uchar_ptr, struc_2 *param_struc_2_ptr, uint32 param_uint_var) {
    uint32 j;
...
static void Test_case_11_07_Func1(void) {
        ...
        for (k = 0; k < 20u; k++) {
            ...
            if (struc_sub_var != NULL) {
                Test_case_11_07_Func2(param_uchar_ptr, struc_sub_var->struc_2_arr, struc_sub_var->uint_var);
