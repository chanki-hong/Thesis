...
const rReal_T const_global_float_arr_1_09[3] = { 0.0, 0.05, 0.5 } ;
const rReal_T const_global_float_arr_2_09[3] = { 20.0, 10.0, 5.0 } ;

#define def_const_global_float_arr_1_09     const_global_float_arr_1_09  
#define def_const_global_float_arr_2_09     const_global_float_arr_2_09 

void Test_case_37_sub_9(uint32_T *param_uint_ptr_1, uint32_T *param_uint_ptr_2, rReal_T u, const
...
void Test_case_37_9(rReal_T *param_uint_ptr_1, const rReal_T *param_uint_ptr_2, rReal_T u, const
  rReal_T *param_uint_ptr_3, uint32_T iHi)
{
  uint32_T uint_var_1;
  uint32_T uint_var_2;
  Test_case_37_sub_9( &(uint_var_1), &(uint_var_2), u, param_uint_ptr_3, iHi);
...
int main_Test_case_37_16() {
      ...
      for (int i1=0; i1 < 20; i1++) {
        Test_case_37_9( &(y0[i1]), def_const_global_float_arr_2_09, u0[i1],
          def_const_global_float_arr_1_09, 2U);
      }
