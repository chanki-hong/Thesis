...
void Test_case_14_41(const rReal_T *Param_float_ptr,
     const uint32_T *Param_uint_ptr, const  rReal_T Param_float_arr[40])
{
 ...
 static void Test_case_14_41_Sink(float input0 )
 {
...
int main_Test_case_14_41(float input0)
{
    float tmp1 =1.0f;
    unsigned int tmp2 = 1U;

    int32_T i;
	Test_case_14_41_Sink( input0 );
	
    Test_case_14_41(&tmp1, &tmp2, float_arr);
    return 0;
}