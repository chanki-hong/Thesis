...
void Init_15(void) {
	...
	struc_var_15.uint_arr[39] = 40u;
}


 static boolean_T Test_case_31_44( int i )
 {
	 return (0 >= ((uint32_T)def_func_15[(i)]));
 }


int main_Test_case_31_44()
{
	int var = 0;
	boolean_T  bool_var;
	boolean_T bool_arr[40];
	int i;
	boolean_T(*funcPtr) (int) = Test_case_31_44;
